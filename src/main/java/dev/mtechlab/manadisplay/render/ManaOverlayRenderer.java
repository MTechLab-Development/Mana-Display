...
public class ManaOverlayRenderer {
    ...
    private static void drawRect(
        ...
        vc.addVertex(m, x1, y2, z).setColor(r, g, b, a);
        vc.addVertex(m, x2, y2, z).setColor(r, g, b, a);
        vc.addVertex(m, x2, y1, z).setColor(r, g, b, a);
    }
    ...
    private static void drawBlueManaBar(
        ...
        for (int i = 0; i < segments; i++) {
            ...
            vc.addVertex(m, px1, y1, z).setColor(r1, g1, b1, 1f);
            vc.addVertex(m, px1, y2, z).setColor(r1, g1, b1, 1f);
            vc.addVertex(m, px2, y2, z).setColor(r2, g2, b2, 1f);
            vc.addVertex(m, px2, y1, z).setColor(r2, g2, b2, 1f);
        }
    }
